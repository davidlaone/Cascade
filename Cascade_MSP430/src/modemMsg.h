...
typedef enum messageType {
    ...
    MSG_TYPE_CAL_WATER_EVENT = 0x30,
    MSG_TYPE_DAILY_LOG = 0x31,
...
/**
 * \typedef OtaOpcode_t 
 * \brief Identify each possible incomming Cascade OTA opcode.
 */
typedef enum otaOpcodes_e {
    ...
    OTA_OPCODE_STATUS_REQUEST = 0x30,
    OTA_OPCODE_SET_FLOWRATE_CONSTANTS = 0x31,
} OtaOpcode_t;
