 ...
 * 
 * \brief Manage the details of sending debug messages.  These 
 *        message are intended for use with the PC data logger.
 */
...
*        the data logger (an application running on a PC).
...
/**
* \brief Send an cascade debug msg to the uart. 
* \ingroup PUBLIC_API
* 
